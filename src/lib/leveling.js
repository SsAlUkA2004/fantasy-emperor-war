...
export const PLAYER_MAX_LEVEL = 150

/**
 * ค่าประสบการณ์ของผู้เล่น ตั้งใจให้ชันกว่าของตัวละครมาก
 *
 * สูตรคือ 24 × เลเวลยกกำลังสอง รวมทั้งหมดถึงเลเวล 150 ต้องใช้ราว 26,700,000 หน่วย
 * ตั้งใจให้พอดีกับผู้เล่นที่ทำเหมืองคริสตัลระดับสูงสุดครบสามครั้งทุกวัน (~72,000 หน่วย/วัน)
 * คือราวหนึ่งปีเต็มถึงจะตันเลเวล เลเวลผู้เล่นจึงเป็นตัวบอกว่าเล่นมานานแค่ไหนจริง ๆ ไม่ใช่แค่ฟาร์มเก่ง
 *
