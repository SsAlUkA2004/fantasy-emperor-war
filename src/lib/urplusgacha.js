...
//   sinceUR     รีเซ็ตเมื่อได้ UR หรือ UR+ (ทั้งคู่ถือว่า "UR ขึ้นไป") ครบ 500 ครั้งการันตี UR ขึ้นไปแน่นอน
...
export const URPLUS_UR_HARD_PITY = 500 // ครบ 500 ครั้งได้ UR ขึ้นไปแน่นอน
