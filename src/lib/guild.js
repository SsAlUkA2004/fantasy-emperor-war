...
/**
 * ซ่อมป้ายกิลด์ (guildTag/guildName) บนเอกสารผู้เล่นให้ตรงกับกิลด์จริง
 *
 * สองฟิลด์นี้เป็นสำเนาที่จดไว้ให้คนอื่นเห็นได้โดยไม่ต้องอ่านเอกสารกิลด์เพิ่ม (ดู createGuild/joinGuild)
 * ถ้าเคยเข้ากิลด์มาก่อนจะมีสำเนานี้ตั้งแต่แรกอยู่แล้ว แต่คนที่เข้ากิลด์ตั้งแต่ก่อนมีสองฟิลด์นี้
 * จะไม่มีสำเนาติดมาด้วย ทำให้เพื่อน/บอร์ดของคนอื่นเห็นว่า "ยังไม่ได้เข้ากิลด์" ทั้งที่อยู่จริง
 * เรียกทุกครั้งที่เจ้าตัวเปิดหน้ากิลด์ของตัวเอง เพราะเขียนได้แค่เอกสารของตัวเองเท่านั้น
 */
export async function syncGuildTag(player, guild) {
  if (player.guildTag === guild.tag && player.guildName === guild.name) return
